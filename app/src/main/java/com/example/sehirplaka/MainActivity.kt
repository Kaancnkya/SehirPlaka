...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.button.setOnClickListener {
            var plakaKodu = binding.plakaInput.text.toString().toInt()
            if (binding.plakaInput.text.isNotEmpty()) {
                when (plakaKodu) {
                ...
                binding.textView.text = "Lütfen geçerli bir plaka giriniz"
            }
            binding.plakaInput.text.clear()
        }
    }
}
